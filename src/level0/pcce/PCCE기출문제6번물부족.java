...
public class PCCE기출문제6번물부족 {
    // ㅇㅇ시에서는 저수지가 하나 있는데,
    // 도시 내에서 사용하는 모든 물은
    // 이 저수지에 저장된 물을 끌어와 사용합니다.
    // 이상 기후로 인해 극심한 가뭄이 예고된 상황에서,
    // 지난 달의 물 사용량과
    // 이번달부터 일정 기간 동안의
    // 월별 물 사용량의 변화를 예측한 값을 이용해
    // 몇 달 뒤 물이 부족해지는지 예측하려고 합니다.
    // 이번달부터의 월별 물 사용량 변화를
    // 예측한 값은 다음과 같이 리스트에 담겨 주어집니다.
    // [10, -10, 10, -10, 10, -10, 10, -10, 10, -10]
    // 리스트의 각 원소는 해당 월의 물 사용량이
    // 전 달에 비해 몇 % 만큼 증가 또는 감소하는지를 나타냅니다.
    ...
    // 월별 물 사용량이 전 달 대비 어떻게 변하는지
    // 저장된 정수 리스트 change가 주어질 때
